            ...
            filtered.forEach(app => {
                ...
                card.innerHTML = `
                    <div class="app-header">
                        <img src="${app.avatar || 'https://cdn.discordapp.com/embed/avatars/0.png'}" class="user-avatar" alt="Avatar">
                        <div class="user-info">
                            <h3>${app.username}</h3>
                    ...
                    <div class="app-body">
                        <div class="app-field">
                            ...
                            <span class="field-value">${app.name}</span>
                        </div>
                        <div class="app-field">
                            <span class="field-label">Age</span>
                            <span class="field-value">${app.age}</span>
                        </div>
                        <div class="app-field">
                            <span class="field-label">Reason for joining</span>
                            <span class="field-value">${app.reason}</span>
                        </div>
                        ${app.rejectReason ? `
